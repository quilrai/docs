...
Go to the **LLM Gateway** tab and click **Create New Key**. Select your provider (OpenAI, Anthropic, Azure, Bedrock, Bedrock Runtime boto3, Vertex AI, OpenAI Responses, OpenAI Realtime, Sarvam, Copilot Studio, or any OpenAI-compatible endpoint), choose which models to expose, and generate your key.
